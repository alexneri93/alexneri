...
import Monster from './components/molecules/Monster.jsx'
  ...
  return (
    <>
      ...
      <main className="lg:col-span-4">
        ...
        <section id="about" className="my-10 lg:m-0 lg:py-10 flex flex-col gap-6 px-5">
        ...
        <section id="experience" className="my-10 lg:m-0 lg:py-10 flex flex-col gap-7 px-5">
        ...
        <section id="projects" className="my-10 lg:m-0 lg:py-10 flex flex-col gap-6 px-5">
